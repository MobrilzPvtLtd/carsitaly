                    ...
                    <form method="POST" action="{{ route('backend.hotel.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-2 col-4">
                                ...
                                <input type="text" class="form-control" name="traveller" placeholder="" value="{{ old('traveller') }}">
                            </div>

                            <div class="form-group mb-2 col-4">
                                <label for="base_ammount">Base Ammount</label>
                                <input type="number" class="form-control" id="base_ammount" name="base_ammount" placeholder="" value="{{ old('base_ammount') }}">
                            </div>

                            <div class="form-group mb-2 col-4">
                                <label for="service_tax">Service Tax</label>
                                <input type="number" class="form-control" id="service_tax" name="service_tax" placeholder="" value="{{ old('service_tax') }}">
                            </div>

                            <div class="form-group mb-2 col-4">
                                <label for="other_taxes">Other Taxs</label>
                                <input type="number" class="form-control" id="other_taxes" name="other_taxes" placeholder="" value="{{ old('other_taxes') }}">
                            </div>
