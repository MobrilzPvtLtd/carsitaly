                    ...
                    <div class="card">
                        <div class="card-body">
                            <x-backend.section-header>
                                ...
                                <x-slot name="toolbar">
                                    <button type="button" id="toggleForm" class='btn btn-warning'><i class="fas fa-reply fa-fw"></i></button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <button type="button" class='btn btn-sm btn-danger mt-1 deleteButton' title="Delete" data-id="{{ $package->id }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="package_city" name="package_city" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-8 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select id="inclusion" name="inclusion[]" class="form-control select3" multiple>
                                                        <option value="">-- Select an option --</option>
                                                        @if($data->service_type == 'cruises')
                                            ...
                                            <div class="col-12 col-sm-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select id="package_status" name="package_status" class="form-control select2">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            function populateForm(packageId) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#packageForm input[name='package_id']").val(response.id);
                        $("#packageForm input[name='package_city']").val(response.city);
                        $("#packageForm input[name='validity']").val(response.validity);

                        // $("#inclusion option").prop("selected", false);
                        // $.each(response.inclusion, function(index, value){
                        //     $("#inclusion option[value='" + value + "']").prop("selected", true);
                        // });

                        $("#packageForm select[name='package_status']").val(response.status);
            ...
            $(".deleteButton").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/admin/tours/delete-packages",
                    data: {
                        id: packageId,
                        _token: token
                    },
