...
@section('services-content')
    ...
    <div class="row page-title">
        <div class="container clear-padding text-center">
            ...
            <span>Paris (2)<i class="fa fa-long-arrow-right"></i>London (2)<i class="fa fa-long-arrow-right"></i>Amesterdam
                (2)</span>
        </div>
    </div>
    <!-- END: PAGE TITLE -->
            ...
            <div class="main-content col-md-8">
                ...
                <div class="package-complete-detail">
                    <ul class="nav nav-tabs tabs001">
                        <li class="active"><a data-toggle="tab" href="#ship-info"><i class="fa fa-ship"></i> <span>Ship
                                    Info</span></a></li>
                        <li><a data-toggle="tab" href="#itinerary"><i class="fa fa-globe"></i> <span>Itinerary</span></a>
                        </li>
                        <li><a data-toggle="tab" href="#cabin"><i class="fa fa-check-square"></i> <span>Cabin
                                    Types</span></a></li>
