...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $super_admin->givePermissionTo('view_backend');
        $supplier->givePermissionTo('view_backend');
