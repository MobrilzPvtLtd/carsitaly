...
class PackagesController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        $query_data = $module_model::limit(7)->get();
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'image', 'service_id','validity', 'city','status');
        ...
        return Datatables::of($$module_name)
            ...
            ->editColumn('image', function ($data) {
                if ($data->image) {
                    return '<a href="' . route('backend.packages.show', $data->id) . '">
                                <img src="' . asset('public/storage/') . '/' . $data->image . '" alt="" width="100px">
                            </a>';
                }
            })
            ->editColumn('service_id', function ($data) {
                $tours = Service::where('service_type', 'tours')->where('status', 1)->get();
            ...
            ->rawColumns(['image','service_id','status', 'action'])
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $imagePath = $request->file('image')->store('tour/package', 'public');
