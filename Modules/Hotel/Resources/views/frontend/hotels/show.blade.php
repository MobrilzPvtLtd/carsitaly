            ...
            <div class="main-content col-md-8">
                ...
                <div class="room-complete-detail">
                    ...
                    <div class="tab-content">
                        <div id="Hotel_Information" class="tab-pane active in fade">
                            <h4 class="tab-heading"> {{ $hotel->title }}</h4>
                            <p>{{ $hotel->description }}</p>
                            <p><b>Category:</b> {{ $hotel->category }} </p>
                        </div>
                        <div id="Location_Details" class="tab-pane fade">
                            <h4 class="tab-heading"> Address: {{ $hotel->address }}</h4>
                        ...
                        <div id="Contact_Information" class="tab-pane fade">
                            ...
                            <p> <b> Email Address:</b> {{ $hotel->email }}</p>
                        ...
                        <div id="Amenities_and_Services" class="tab-pane fade">
                            <h4 class="tab-heading">Amenities:
                                @if ($hotel->amenities > 0)
                                    @foreach (json_decode($hotel->amenities) as $amenities)
                        ...
                        <div id="Media" class="tab-pane fade">
                            ...
                            @if ($hotel->images)
                                ...
                                @if ($images && count($images) > 0)
                                    @foreach ($images as $index => $image)
                                        <img src="{{ asset('public/storage/' . $image) }}" alt="Hotel" width="100px">
                                    @endforeach
                                @endif
                            @endif
                            <h4>Videos:</h4>
                        ...
                        {{-- <div id="ammenties" class="tab-pane fade">
                            ...
                            <div class="ammenties-3">
                                ...
                                @foreach (json_decode($hotel->facilities) as $facili)
                                    <div class="col-md-4 col-sm-6">
                                        @if ($facili == 'wifi')
                ...
                <div class="col-md-12 sidebar-wrapper clear-padding">
                    ...
                    <div class="contact sidebar-item">
                        ...
                        <div class="sidebar-item-body">
                            ...
                            <h5><i class="fa fa-map-marker"></i> {{ $hotel->address }}, {{ $hotel->city }},
                                {{ $hotel->country }}, {{ $hotel->pin_code }}</h5>
                        </div>
                    </div>
