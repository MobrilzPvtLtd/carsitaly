...
namespace Modules\Villa\Http\Controllers\Backend;
...
class VillasController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module_path = 'villa::backend';
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::where('service_type', 'villa')->select('id', 'image', 'title', 'price','city','mobile', 'rating', 'status');
