                        ...
                        <div  class="hotel-list-view">
                            <div class="wrapper">
                                <div class="col-md-4 col-sm-6 switch-img clear-padding">
                                    <img src="{{ asset('public/storage/') . '/' . $villa->image }}" alt="cruise">
                                </div>
                                <div class="col-md-6 col-sm-6 hotel-info">
                                    <div>
                                        <div class="hotel-header">
                                            ...
                                            <p>
                                                <i class="fa fa-map-marker"></i>{{ $villa->city }}
                                                <i class="fa fa-phone"></i>(+91) {{ $villa->mobile }}</p>
                                        </div>
