...
"><i class="fa fa-map-marker"></i> <span>Reviews
                    ...
                    <div class="tab-content">
                        <div id="Cruise_Information" class="tab-pane fade">
                    ...
                    <div class="tab-content">
                        <div id="Itinerary_and_Destinations" class="tab-pane fade">
                            <h4 class="tab-heading"> Departure Port: Starting location of the cruise.</h4>
                            <h4>
                    ...
                    <div class="tab-content">
                        <div id="Onboard_Services_and_Amenities" class="tab-pane fade">
                            <h4 class="tab-heading">Included Services: List of items or services included in the cruise price (e.g., meals, 
                                entertainment, excursions).
                                </h4>
                            <p>
                                <b> Optional Services:</b>  List of optional items or services available for an additional fee (e.g., spa treatments, specialty dining).
                            </p>
                            <p>
                                <b>  Entertainment Options:</b> Description of onboard entertainment options (e.g., shows, movies, live music).
                            </p>
                            <p>
